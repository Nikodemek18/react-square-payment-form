...
var CreditCardPostalCodeInput = (function (_super) {
    __extends(CreditCardPostalCodeInput, _super);
    function CreditCardPostalCodeInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CreditCardPostalCodeInput.prototype.render = function () {
        var _this = this;
    ...
    return CreditCardPostalCodeInput;
}(React.Component));
exports.default = CreditCardPostalCodeInput;
